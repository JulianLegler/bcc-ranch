...
Config.RanchSetup = {
    ...
    animalFollowSettings = { --set the offset that the ranch animals will follow the player around while herding or selling test around to find whatt you like
        offsetX = 5.0,
        offsetY = 5.0,
        offsetZ = 0.0 --Recommended to leave at 0 this is the height variable
    },
    ...
    RanchAnimalSetup = { --ranch animal setup
        Cows = {
            ...
            HerdingCooldown = 10800,  -- (3h) seconds in between being able to do chores
        ...
        Goats = {
            ...
            HerdingCooldown = 3600,  -- (1h) seconds in between being able to do chores
